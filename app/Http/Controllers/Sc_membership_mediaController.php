...
class Sc_membership_mediaController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($keyword)) {
            $sc_membership_media = Sc_membership_media::where('about', 'LIKE', "%$keyword%")
            ...
            $sc_membership_media = Sc_membership_media::latest()->paginate($perPage);
        }

        return view('sc_membership_media.index', compact('sc_membership_media'));
    }
    ...
    {
        return view('sc_membership_media.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        { 
         ...
         $requestData['popup_image'] =  $popup_url;
           ...
           $a = Sc_membership_media::create($requestData);
             

           if($a)
           { 
            return redirect('sc_membership_media')->with('flash_message', 'Media Added');
           }
           else{
             return redirect('sc_membership_media')->with('flash_message', 'Something went wrong on Media Added!!');
           } 
    ...
    {
        $sc_membership_media = Sc_membership_media::findOrFail($id);

        return view('sc_membership_media.show', compact('sc_membership_media'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('sc_membership_media.edit', compact('sc_membership_media'));
    }
        ...
        $upload_success = Cloudder::upload($popup_name, null, array("folder"=>"swa_cms","use_filename"=>TRUE ,"unique_filename"=>FALSE));
         ...
         { 
          ...
          $requestData['popup_image'] =  $popup_url;
           ...
           $sc_membership_media = Sc_membership_media::findOrFail($id);
           $a = $sc_membership_media->update($requestData);
    ...
    {
        Sc_membership_media::destroy($id);

        return redirect('sc_membership_media')->with('flash_message', 'Media deleted!');
    }
}
